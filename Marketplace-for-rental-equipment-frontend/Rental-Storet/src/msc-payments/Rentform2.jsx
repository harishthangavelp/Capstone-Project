      ...
      <div className='rentbg'>
        <form className='rentForm' action="https://formspree.io/f/mgvwqrae" method="POST">
          ...
          <input
            ...
            required
          />
          <img className="rentimg1" src={hsrentimg2} alt="" />
          <br />
          <input
            type="text"
            value={timeform}
          ...
          <button
            ...
            onClick={() => handleCheckout('price_1QFVCjFxddvTxBZJgzwCAurq')}
          >
            Pay
          </button>
        ...
        <Modal show={showPopup} onHide={handleClosePopup}>
          ...
          <Modal.Body>
            <p>Are you sure you want to proceed to the payment page?</p>
          </Modal.Body>
          <Modal.Footer>
            <button
              className="btn btn-danger"
              onClick={() => handleConfirmPayment('price_1QFVCjFxddvTxBZJgzwCAurq')}
            >
              Yes
            </button>
