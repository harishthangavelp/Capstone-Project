...
<img className="rentbdsimg1" src={hsrbdsimg13}  alt="" /> <br />  
...
<button type="submit" onClick={() => handleCheckout('price_1QFVllFxddvTxBZJN7B8vTne')} className='bookDonebds1'>Pay</button>
