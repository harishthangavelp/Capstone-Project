...
import { Modal } from 'react-bootstrap'; // Modal for popup
import hsrbdsimg12 from '../new-images/bds2.webp';
...
function Rentform12() {
    ...
    const [confirmPayment, setConfirmPayment] = useState(false); // Confirm payment modal state
    ...
    const handlePayClick = () => {
        setConfirmPayment(true); // Open confirmation popup
    };

    const handleConfirmPayment = () => {
        setConfirmPayment(false); // Close confirmation popup
        handleCheckout('price_1QFVkgFxddvTxBZJqmAizXuJ'); // Proceed to Stripe checkout
    };
        ...
        <div className='bdsbgbody'>
            <div className='bdsbg'>
                <form className='bdsForm' action="https://formspree.io/f/mgvwqrae" method="POST">
                    ...
                    <img className="rentbdsimg1" src={hsrbdsimg12} alt="" /> <br />
                    ...
                    <button type="button" onClick={handlePayClick} className='bookDonebds1'>Pay</button>
                ...
                <button type="button" className='rentbackbds'>
                    <Link to="/department-stores" className='rentbacksubbds'>Back</Link>
                </button>
                ...
                <Modal show={confirmPayment} onHide={handleCancelPayment}>
                    <Modal.Header closeButton>
                    ...
                    <Modal.Footer>
                        ...
                        <button className="btn btn-success" onClick={handleCancelPayment}>No</button>
                    </Modal.Footer>
                </Modal>
            </div>
        </div>
