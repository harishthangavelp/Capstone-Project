...
<input type="text" value={timeform} className='jourTime' placeholder="How many days" name="Pickup Time" onChange={(e)=> setTimeform(e.target.value)} required/>
<input type="text" value={dmyform} className='jourDmy' placeholder="Mention D/M/Y" name="Pickup D/M/Y" onChange={(e)=> setDmyform(e.target.value)} required/>
